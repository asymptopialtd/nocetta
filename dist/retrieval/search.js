...
export function rankedSearch(nodes, repoState, query, locator) {
...
export function searchMemory(nodes, repoState, query, locator) {
...
export function contextTriggered(nodes, repoState, filesInPlay, opts = {}, locator) {
