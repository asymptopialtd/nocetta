...
const HEADING = /^#{1,6}\s+(.*)$/;
function extractHeadingSpans(filePath, source) {
 ...
 */
function extractTableRowSpans(filePath, source) {
    const lines = source.split("\n");
    const spans = [];
    let i = 0;
 ...
 */
export function extractContentSpans(filePath, source) {
...
export function locateContent(anchor, sourceAfter) {
