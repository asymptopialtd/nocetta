 ...
 * best effort.
 */
export const ANCHOR_STRATEGY_BY_EXTENSION = {
 ...
 */
export function strategyFor(artifactPath, verb) {
    ...
    throw new Error(`${verb ? `${verb}: ` : ""}no anchor strategy for ${named} — anchored kinds support TypeScript/JavaScript, GDScript, Python, and Go sources and Markdown documents`);
}
/**
 ...
 */
export function locateAnchor(anchor, sourceAfter, locator) {
