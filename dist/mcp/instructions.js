...
Humans: \`nocetta ls\` browses the store, \`nocetta ledger\` shows which memories earn their keep; \`nocetta check --strict\` is the CI gate (exit 1 when memories need attention) — keep it green like tests.`;
