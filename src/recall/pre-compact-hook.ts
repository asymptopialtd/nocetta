import { appendRecall } from "./log.js";
 ...
 */
export function runPreCompactHook(repoRoot: string, input: PreCompactHookInput): void {
  appendRecall(repoRoot, { t: new Date().toISOString(), kind: "compaction", ids: [], session: input.session_id });
}
